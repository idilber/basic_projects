...
arepas_items = {'arepa pabellon': 7.00, 'pernil arepa': 8.50, 'guayenes arepa': 8.00, 'jamon arepa': 7.50}
...
class Franchise:
  ...
  def __repr__(self):
    return "Here is our {address}".format(address=self.address)
...
arepas_place = Franchise("189 Fitzgerald Avenue", [brunch_menu, early_bird_menu, dinner_menu, kids_menu, arepas_menu])
